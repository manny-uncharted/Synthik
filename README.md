...
| ------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Synapse SDK**           | Handles encrypted dataset uploads to Filecoin with Proof-of-Data-Possession | • Automated proof set management<br>• Smart provider selection<br>• USDFC payment abstraction<br>• CDN integration support                                                                                                                                                                      |
| **FilCDN**                | Delivers dataset previews & metadata instantly to buyers before purchase    | • Direct HTTPS access (no wallet needed)<br>• Global edge caching<br>• URL pattern: `https://{address}.calibration.filcdn.io/{cid}`                                                                                                                                                             |
