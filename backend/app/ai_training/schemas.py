...
class AITrainingJobBase(BaseModel):
    ...
    dataset_url: Optional[str] = PydanticField(None, max_length=2048, description="URL to the dataset to be used for training.")
    # dataset_url: str = "https://0x311e26702aba231c321c633d1ff6ecb4445f2308.calibration.filcdn.io/baga6ea4seaqhv7zvx7ykx6pady5fk5fbz422ohupjgd6vvzwwjnlotgs22lzqka"
