...
from app.storage.utils.ipld.storage import IPLDDataStorage
from app.storage.utils.ipld.dag_pb import create_dag_node, parse_dag_node
from app.storage.utils.ipld.optimized_codec import OptimizedEncoder, OptimizedDecoder
from app.storage.utils.ipld.vector_store import IPLDVectorStore, SearchResult
...
class IPLDDataKnowledgeGraph:
    ...
    def __init__(
        ...
        storage: Optional[IPLDDataStorage] = None,
        ...
        """
        self.name = name
        self.storage = storage or IPLDDataStorage()
    ...
    def from_cid(
        ...
        storage = storage or IPLDDataStorage()
    ...
    def __str__(self) -> str:
        ...
        return f"IPLDDataKnowledgeGraph(name={self.name}, entities={len(self.entities)}, relationships={len(self.relationships)})"
