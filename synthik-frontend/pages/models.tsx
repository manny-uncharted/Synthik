...
const mockModels = [
  {
    ...
    filecoinCID: 'baga6ea4seaqjycrcayifens5xie3qt2tfsxpnoj4hu4dv4u2jl3tryu3owb5gha',
  ...
  // {
  //   id: 'qwen2.5-1.5b-ccrl-cur-uni-1e',
  //   name: 'Medical QA (Qwen2.5) textgen',
  //   description:
  //     'Medical question-answering model trained on synthetic patient consultation data',
  //   provider: 'chansung',
  //   baseModel: 'Qwen2.5-1.5B-CCRL-CUR-UNI-1E',
